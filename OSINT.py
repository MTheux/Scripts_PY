#script mostro feito pelo brabo ¨#thezakman"
...
titulos = ["[Documentos]", "[Listagem de Diretório]", "[Arquivos de Config]","[Databases]","[Backups]","[Paginas de Login]","[Erros]","[SQLi]","[REPOSITÓRIOS]","[HAILMARY?]"]
dorks = ['site:{} ext:doc | ext:docx | ext:odt | ext:rtf | ext:sxw | ext:psw | ext:ppt | ext:pptx | ext:pps | ext:csv | ext:pdf'.format(str(host)),
         ...
         'site:{} intext:error | intext:sql'.format(str(host)),
